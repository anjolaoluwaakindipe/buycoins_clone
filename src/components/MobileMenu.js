...
function MobileMenu({ setMenuOpen }) {
    return (
        <div className="MobileMenu__container">
            <div className="MobileMenu__innercontainer">
                ...
                <ul className="MobileMenu__middle">
                    <li className="MobileMenu__listitem">
                        <a href="/">Buycoins Pro</a>
                    </li>
                    <li className="MobileMenu__listitem">
                        <a href="/">Learn</a>
                    </li>
                ...
                <div className="MobileMenu__bottom">
                    <Button innerButtonStyle="MobileMenu__button">
                        {" "}
                        Get Started{" "}
                        <span className="MobileMenu__buttonlogo">
                            <svg
                                width="18"
                                height="17"
                                viewBox="0 0 18 17"
